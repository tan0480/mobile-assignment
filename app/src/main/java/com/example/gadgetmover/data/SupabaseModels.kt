...
data class OrderRow(
    ...
    @SerialName("return_received_at") val returnReceivedAt: String? = null,
    @SerialName("created_at") val createdAt: String = ""
)
...
data class ReturnRequestRow(
    ...
    @SerialName("return_methods") val returnMethods: List<String> = emptyList(),
    @SerialName("meetup_locations") val meetupLocations: List<MeetupLocation> = emptyList(),
    val description: String = "",
...
fun ReturnRequestRow.toReturnRequest(): ReturnRequest = ReturnRequest(
    ...
    returnMethods = returnMethods.mapNotNull { runCatching { ReturnMethod.valueOf(it) }.getOrNull() }.toSet(),
    meetupLocations = meetupLocations,
    description = description,
    photoUrls = photoUrls,
