...
/** A generic radio-style selectable option card — shared by Checkout and the return/refund flow. */
@Composable
fun SelectableCard(title: String, subtitle: String? = null, trailing: String? = null, isSelected: Boolean, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
